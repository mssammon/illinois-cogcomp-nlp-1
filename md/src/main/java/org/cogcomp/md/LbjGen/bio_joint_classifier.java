...
public class bio_joint_classifier extends SupportVectorMachine
{
  ...
  public static bio_joint_classifier instance;

  public static bio_joint_classifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private bio_joint_classifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "org.cogcomp.md.LbjGen";
    name = "bio_joint_classifier";
    setEncoding(null);
    setLabeler(new bio_label());
    setExtractor(new bio_joint_classifier$$1());
    isClone = false;
  }
  ...
  public bio_joint_classifier()
  {
    super("org.cogcomp.md.LbjGen.bio_joint_classifier");
    isClone = true;
  }

  public bio_joint_classifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public bio_joint_classifier(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(bio_joint_classifier.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(bio_joint_classifier.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(bio_joint_classifier.class, lexiconPath));
    }
    else {
      containingPackage = "org.cogcomp.md.LbjGen";
      name = "bio_joint_classifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Constituent || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'bio_joint_classifier(Constituent)' defined on line 279 of md.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: org.cogcomp.md.LbjGen.bio_joint_classifier \\");
  ...
  public int hashCode() { return "bio_joint_classifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof bio_joint_classifier; }
