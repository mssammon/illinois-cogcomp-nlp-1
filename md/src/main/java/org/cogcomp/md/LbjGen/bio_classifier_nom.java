...
public class bio_classifier_nom extends SupportVectorMachine
{
  private static void loadInstance()
  {
    if (instance == null) instance = new bio_classifier_nom(true);
  }
  ...
  public static bio_classifier_nom instance;

  public static bio_classifier_nom getInstance()
  {
    loadInstance();
    return instance;
  }

  private bio_classifier_nom(boolean b)
  {
    super(new Parameters());
    containingPackage = "org.cogcomp.md.LbjGen";
    name = "bio_classifier_nom";
    setEncoding(null);
    setLabeler(new bio_label());
    setExtractor(new bio_classifier_nom$$1());
    isClone = false;
  }
  ...
  public bio_classifier_nom()
  {
    super("org.cogcomp.md.LbjGen.bio_classifier_nom");
    isClone = true;
  }

  public bio_classifier_nom(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public bio_classifier_nom(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(bio_classifier_nom.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(bio_classifier_nom.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(bio_classifier_nom.class, lexiconPath));
    }
    else {
      containingPackage = "org.cogcomp.md.LbjGen";
      name = "bio_classifier_nom";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Constituent || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'bio_classifier_nom(Constituent)' defined on line 217 of md.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: org.cogcomp.md.LbjGen.bio_classifier_nom \\");
  ...
  public int hashCode() { return "bio_classifier_nom".hashCode(); }
  public boolean equals(Object o) { return o instanceof bio_classifier_nom; }
